...
| Vulnerability Mgmt | SOC2 CC7 / CMMC RA | Run automated dependency, SAST, image, secret scans | `.github/workflows/security.yml`, `reports/`, `docs/RELEASE_COMPLETION_PLAN.md`, `docs/evidence/phase45_mission_control_convergence_and_final_release_qualification.md` |
