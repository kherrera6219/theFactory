...
| Vulnerability Mgmt | SOC2 CC7 / CMMC RA | Run automated dependency, SAST, image, secret scans | `.github/workflows/security.yml`, `reports/`, `docs/PRODUCTION_REVIEW_AUDIT.md` |
