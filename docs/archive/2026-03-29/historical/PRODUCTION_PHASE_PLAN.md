...
Current-state note (2026-03-29): this document is retained as a historical production-hardening plan. For the canonical remaining-release sequence, use [`RELEASE_COMPLETION_PLAN.md`](RELEASE_COMPLETION_PLAN.md).
