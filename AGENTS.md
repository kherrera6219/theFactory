...
| `services/semantic-bus-mcp/` | **Medium** | Protocol Bus MCP (`:8102`) — protocol routing. Do not rename streams without updating all consumers. _(Service renamed to protocol-bus-mcp in #190; on-disk directory rename pending.)_ |
