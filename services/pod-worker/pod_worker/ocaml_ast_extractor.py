"""ocaml_ast_extractor.py — Structural AST-based extraction for OCaml.

Mirrors the design of ``ast_extractor.py`` for Python:
- Structural analysis for OCaml modules, open imports, type declarations, let bindings, and exceptions.
