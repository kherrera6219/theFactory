...
_LANGUAGE_TOOLING: dict[str, str] = {
    ...
    "go": "Go toolchain and module ecosystem references",
    ...
    "haskell": "GHC toolchain and Hackage ecosystem references",
    "ocaml": "OCaml compiler and opam ecosystem references",
