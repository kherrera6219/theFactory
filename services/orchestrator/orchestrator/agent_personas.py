...
_LANGUAGE_TOOLING: dict[str, str] = {
    ...
    "go": "Go toolchain, go vet/gofmt, and module ecosystem references",
    ...
    "haskell": "GHC/Cabal/Stack toolchain and HLint formatter references",
    "ocaml": "OCaml compiler, dune build tool, and ocamlformat references",
